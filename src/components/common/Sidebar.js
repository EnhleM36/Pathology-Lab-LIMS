  ...
  const menuItems = [
    {
      ...
      allowedRoles: ['admin', 'doctor', 'technician', 'receptionist'],
    },
    {
      name: 'Patients',
      path: '/patients',
    ...
    },
    {
      ...
      allowedRoles: ['admin', 'technician', 'receptionist'],
    },
    {
      name: 'Appointments',
      path: '/appointments',
        ...
        <div className="flex flex-col h-0 flex-1 border-r border-gray-200 bg-white">
          <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
            <div className="flex items-center flex-shrink-0 px-4">
              <h1 className="text-xl font-bold text-blue-600">Pathology Lab</h1>
            </div>
